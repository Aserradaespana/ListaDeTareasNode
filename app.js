...
function mostrarMenu() {
    ...
    console.log("=====================".blue);
    console.log(" Seleccionar opcion ".blue);
    console.log("=====================\n".blue);

    console.log(`${ '1.'.green } Crear Tarea`);
    console.log(`${ '2.'.green } Eliminar Tarea`);
    console.log(`${ '3.'.green } Completar Tarea(s)`);
    console.log(`${ '4.'.green } Mostrar Tarea(s)`);
    console.log(`${ '5.'.green } Salir\n`);


rl.question("Seleccione una opción: ".yellow, async (opcion) => {
    switch (opcion) {
    case "1":
        await agregarTarea();
        mostrarMenu();
